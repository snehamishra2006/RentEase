...
const seedData = async () => {
  try {
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/rentease');
    ...
    const admin = await User.create({
      ...
      avatar: 'https://ik.imagekit.io/f8khymiop/9dd2906190f0c1813429fe0c8695ed04.png?updatedAt=1786639995780',
    });
    ...
    console.log('Created Demo Users (Admin, Owners, Tenants)...');
    ...
    // Create Active Rental for tenant1 on prop1
    ...
    // Maintenance Request for rental1
    ...
    console.log('Seeded Applications, Rentals, Payments, Maintenance & Notifications!');
    console.log('\n--- DEMO USER CREDENTIALS ---');
    console.log('Admin  : admin.anjali@gmail.com     / Password123!');
    console.log('Owner  : satveer.singh92@gmail.com  / Password123!');
    console.log('Tenant : deepanshusingh542005@gmail.com  / Password123!');
    console.log('-----------------------------\n');
